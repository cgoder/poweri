...
// Running-status broadcaster. Keep listeners on globalThis so an SSE stream
// remains connected across Next.js hot reloads.
...
/** Recompute and broadcast only when the running session set changed. */
